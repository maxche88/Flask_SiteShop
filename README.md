...
*Редактирование профиля: изменение имени, email (с подтверждением) и пароля (скрыт ввод).*

![Админка — главная](screenshots/index.admin.png)  
*Главная страница администратора: обзор активности, пользователей и системных метрик.*

![Карточка товара](screenshots/product.png)  
*Страница товара с изображением, описанием и кнопкой добавления в корзину.*

![Админ-панель: управление](screenshots/admin_panel.png)  
*Панель управления товарами, пользователями и заказами — центральный инструмент для администратора.*

![Админ-панель: логи](screenshots/admin_panel.logs.png)  
*Просмотр системных логов — упрощает аудит и диагностику ошибок.*

![QA-чек-листы](screenshots/checklist.png)  
*Интерфейс для QA-тестирования: отметка статусов (Passed/Failed/Blocked/Skipped), комментарии, динамическое редактирование.*

![Баг-репорт](screenshots/bug-report.png)  
*Отправка отчёта об ошибке с возможностью прикрепить файл (скриншот, лог).*

![Панель сообщений](screenshots/message-panel.png)  
*Внутренний чат: обмен сообщениями между пользователями с поддержкой вложений.*

![Панель сообщений (альтернативный вид)](screenshots/message_panel.png)  
*Альтернативное отображение диалогов — адаптировано под разные сценарии использования.*
